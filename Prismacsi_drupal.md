...
---------------------------------------------
## PRISMACSI firmasının yayınladığı typhoon makinesindeki drupal ve linux kernel versiyonundan kaynaklanan zafiyetlerden yararlanarak ele geçirmemi anlatacağım.
